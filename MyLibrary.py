...
def print_text(font, surface, x, y, text, color=(255,255,255)):
...
class PlayerEffect(MySprite):
    ...
    def update(self, current_time, newrate=1000):

        MySprite.update(self, current_time, rate=30)

        self.rect.center=self.target.rect.center

        if current_time> self.start+newrate:
            self.duration-=1
...
class Exploder(MySprite):
    ...
    def update(self, current_time, newrate=1000):
        ...
        self.first_frame = self.explode* self.columns
